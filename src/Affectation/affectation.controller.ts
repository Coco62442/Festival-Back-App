...
export class AffectationController {
  ...
  @Post('removeBenevoles')
  @UseGuards(JwtAuthGuard)
  removeBenevolesFromAffectation(@Body() data: [AffectationBenevolesDto]): Promise<Boolean> {
    return this.affectationService.removeBenevoles(data)
      .catch(error => {
        throw new HttpException(error.message, error.status);
      });
  }
  ...
  @Post('addBenevoles')
  @UseGuards(JwtAuthGuard)
  addBenevolesToAffectation(@Body() data: [AffectationBenevolesDto]): Promise<Boolean> {
    return this.affectationService.addBenevoles(data)
      .catch(error => {
        throw new HttpException(error.message, error.status);
      });
  }
